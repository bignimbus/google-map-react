            ...
            GoogleMapMarkers.prototype.render = function render() {
              ...
              var markers = _react2.default.Children.map(
                ...
                function(child, childIndex) {
                  ...
                  var pt = _this2.props.projectFromLeftTop
                    ? _this2.props.geoService.fromLatLngToContainerPixel(latLng)
                    : _this2.props.geoService.project(latLng);
                  ...
                  if (
                    ...
                    var seLatLng = child.props.seLatLng !== undefined
                      ? child.props.seLatLng
                      : { lat: child.props.seLat, lng: child.props.seLng };

                    var sePt = _this2.props.projectFromLeftTop
                      ? _this2.props.geoService.fromLatLngToContainerPixel(
                          seLatLng
                        )
                      : _this2.props.geoService.project(seLatLng);
                  ...
                  .then(function(maps) {
                    ...
                    maps.event.addListener(map, 'zoom_changed', function() {
                      ...
                      if (this_.geoService_.getZoom() !== map.getZoom()) {
                        ...
                        // simulate it.
                        if (
                          mapsVersion < DRAW_CALLED_DURING_ANIMATION_VERSION
                        ) {
	...
	**/
        ...
        /***/ function(module, exports, __webpack_require__) {
          ...
          var Geo = (function() {
            ...
            Geo.prototype.setMapCanvasProjection = function setMapCanvasProjection(
              maps,
              mapCanvasProjection
            ) {
              this.maps_ = maps;
            ...
            Geo.prototype.fromLatLngToContainerPixel = function fromLatLngToContainerPixel(
              ptLatLng
            ) {
