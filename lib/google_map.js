...
var GoogleMap = (function(_Component) {
  ...
  function GoogleMap(props) {
    ...
    _this._getMinZoom = function() {
      if (
        _this.geoService_.getWidth() > 0 || _this.geoService_.getHeight() > 0
      ) {
    ...
    _this._mapDomResizeCallback = function() {
      ...
      if (_this.maps_) {
        ...
        _this.map_.setCenter(
          _this.props.resetBoundsOnResize ? originalCenter : currentCenter
        );
      }
    };
          ...
          var overlay = Object.assign(new maps.OverlayView(), {
            onAdd: function onAdd() {
              ...
              _reactDom2.default.unstable_renderSubtreeIntoContainer(
                this_,
                _react2.default.createElement(_google_map_markers2.default, {
    ...
    _this._onDrag = function() {
      ...
      return _this.props.onDrag &&
        (_this$props2 = _this.props).onDrag.apply(_this$props2, arguments);
    };
      ...
      if (_this.childMouseDownArgs_) {
        if (_this.props.onChildMouseUp) {
          ...
          (_this$props7 = _this.props).onChildMouseUp.apply(
            _this$props7,
            _this.childMouseDownArgs_.concat([_extends({}, _this.mouse_)])
          );
        }
    ...
    _this._onClick = function() {
      ...
      return _this.props.onClick &&
        ...
        new Date().getTime() - _this.childMouseUpTime_ > K_IDLE_CLICK_TIMEOUT &&
        _this.dragTime_ === 0 &&
        (_this$props11 = _this.props).onClick.apply(_this$props11, arguments);
    };
    ...
    if (
      _this._isCenterDefined(_this.props.center || _this.props.defaultCenter)
    ) {
      var propsCenter = latLng2Obj(
        _this.props.center || _this.props.defaultCenter
      );
  ...
  GoogleMap.prototype.componentWillReceiveProps = function componentWillReceiveProps(
    ...
    if (this.map_) {
      ...
      if (
        ...
        !(0, _shallowEqual2.default)(this.props.draggable, nextProps.draggable)
      ) {
      ...
      if (
        ...
        !(0, _shallowEqual2.default)(this.props.options, nextProps.options)
      ) {
        var mapPlainObjects = (0, _pick2.default)(
          this.maps_,
          _isPlainObject2.default
  ...
  GoogleMap.prototype.render = function render() {
    var mapMarkerPrerender = !this.state.overlayCreated
      ? _react2.default.createElement(_google_map_markers_prerender2.default, {
